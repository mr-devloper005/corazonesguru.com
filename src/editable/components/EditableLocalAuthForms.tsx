...
const inputClass = 'h-12 rounded-2xl border border-[#ead9c6] bg-white/92 px-4 text-base font-bold text-[#24150f] outline-none transition placeholder:text-[#846d5f] focus:border-[#f1763d] focus:bg-white'
const buttonClass = 'inline-flex h-12 items-center justify-center rounded-2xl bg-[#f1763d] px-6 text-sm font-black uppercase tracking-[0.18em] text-white transition hover:-translate-y-0.5 hover:bg-[#ff8957] disabled:opacity-60'
