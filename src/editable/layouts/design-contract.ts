...
export const editableRootStyle = {
  ...
  '--slot4-panel-bg': '#0d0d0d',
  '--slot4-surface-bg': '#111111',
  '--slot4-muted-text': '#8a8a8a',
  '--slot4-soft-muted-text': '#6b6b6b',
  '--slot4-accent': '#ff3d8b',
  '--slot4-accent-fill': '#ff3d8b',
  '--slot4-accent-soft': 'rgba(255,61,139,0.12)',
  '--slot4-dark-bg': '#000000',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#1a1a1a',
  '--slot4-cream': '#0a0a0a',
  '--slot4-warm': '#080808',
  '--slot4-lavender': '#0e0e0e',
  '--slot4-gray': '#0b0b0b',
  '--slot4-body-gradient': 'linear-gradient(180deg, #050505 0%, #0a0a0a 38%, #050505 100%)',
} as CSSProperties
...
export const editableDesignContract = {
  ...
  type: {
    ...
    heroTitle: 'text-4xl font-light leading-[1.08] tracking-[-0.02em] sm:text-5xl lg:text-[3.5rem]',
    sectionTitle: 'text-3xl font-light tracking-[-0.02em] sm:text-4xl',
  ...
  button: {
    primary: `inline-flex items-center justify-center rounded-sm ${editablePalette.accentBg} px-7 py-3 text-sm font-semibold text-white tracking-[0.08em] uppercase transition hover:opacity-90`,
    secondary: `inline-flex items-center justify-center rounded-sm border ${editablePalette.border} px-7 py-3 text-sm font-semibold ${editablePalette.surfaceText} tracking-[0.08em] uppercase transition hover:bg-white/[0.05]`,
    accent: `inline-flex items-center justify-center rounded-sm ${editablePalette.accentBg} px-7 py-3 text-sm font-semibold text-white tracking-[0.08em] uppercase transition hover:opacity-90`,
  },
  media: {
