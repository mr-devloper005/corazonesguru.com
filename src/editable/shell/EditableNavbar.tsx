...
export function EditableNavbar() {
  ...
  const navVars = { '--editable-nav-bg': '#2f2118', '--editable-nav-text': '#fff4e6', '--editable-nav-active': '#fff4e6', '--editable-nav-active-text': '#2f2118', '--editable-cta-bg': '#f1763d', '--editable-cta-text': '#fff8ef', '--editable-search-bg': '#493629', '--editable-border': 'rgba(246,201,150,0.28)', '--editable-container': '1120px' } as CSSProperties
